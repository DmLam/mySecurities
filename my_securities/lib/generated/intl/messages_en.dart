...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m1(portfolio_name) => "Import operations into ${portfolio_name}";

  static m2(description) => "Are you sure you want to delete operation \'${description}\'?";

  static m3(portfolio, ticker) => "${portfolio} transactions on ${ticker}";

  static m4(description) => "Are you sure you want to delete operation \'${description}\'?";

  static m5(portfolio_name) => "Commission for \'${portfolio_name}\' portfolio";

  static m6(portfolio_name) => "Percent in \'${portfolio_name}\' portfolio";

  static m7(portfolio) => "${portfolio} money operations";

  static m8(portfolio) => "${portfolio} transactions";

  static m9(name) => "Are you sure you want to delete portfolio \'${name}\'?";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "importPortfolioOperationsPageSelectFile" : MessageLookupByLibrary.simpleMessage("Select xlsx file for import"),
    ...
    "portfolioInstrumentPageMenuImportOperations" : MessageLookupByLibrary.simpleMessage("Import operations"),
