...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(portfolio, ticker) => "${portfolio} transactions on ${ticker}";

  static m3(description) => "Are you sure you want to delete operation \'${description}\'?";

  static m4(portfolio_name) => "Commission for \'${portfolio_name}\' portfolio";

  static m5(portfolio_name) => "Percent in \'${portfolio_name}\' portfolio";

  static m6(portfolio) => "${portfolio} money operations";

  static m7(portfolio) => "${portfolio} transactions";

  static m8(name) => "Are you sure you want to delete portfolio \'${name}\'?";
